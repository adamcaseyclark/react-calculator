...
describe("Trigonometric Function Keys - Inverse Hyperbolic Sine In Radians", () => {
  ...
  it("-1 Radians Returns A Value Of -0.881373587019543", () => {
    ...
    cy.get(LocatorConstants.DISPLAYED_VALUE).then(
      ($displayAfterEnteringNegativeOne) => {
        ...
        cy.get(LocatorConstants.DISPLAYED_VALUE).then(
          ($displayAfterSelectingInverseCosineOnNegativeOne) => {
            cy.wrap($displayAfterSelectingInverseCosineOnNegativeOne).should(
              "have.text",
              "-0.881373587019543"
            );
          }
