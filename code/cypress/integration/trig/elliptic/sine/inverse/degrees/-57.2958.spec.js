...
describe("Trigonometric Function Keys - Inverse Sine In Degrees", () => {
  ...
  it("-57.2958 Degrees Returns A Value Of -1.57079632679489(7|66)", () => {
    ...
    cy.get(LocatorConstants.DISPLAYED_VALUE).then(
      ($displayAfterEnteringNegative57Point2958) => {
        cy.wrap($displayAfterEnteringNegative57Point2958).should(
          "have.text",
          "-57.2958"
        );
        ...
        cy.get(LocatorConstants.DISPLAYED_VALUE).then(
          ($displayAfterSelectingInverseSineOnNegative57Point2958) => {
            assert.match(
              $displayAfterSelectingInverseSineOnNegative57Point2958.text(),
