...
describe("log 10 Key on Calculator", () => {
  ...
  it("Selecting log 10 With No Value To Calculate Will Yield Not A Number Display", () => {
    ...
    cy.get(LocatorConstants.DISPLAYED_VALUE).then(($displayAfterSelectingBase10On0) => {
      cy.wrap($displayAfterSelectingBase10On0).should("have.text", MessageConstants.NOT_A_NUMBER);
    });
  });
});
